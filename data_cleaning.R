...
covariates <- cons1%>%dplyr::select("HHID", "State_Region","Cooking_Code", "Lighting_Code", "Dwelling_unit_Code", "Regular_salary_earner", "Possess_ration_card", "type_of_ration_card", "MPCE_URP", "MPCE_MRP", "HH_Size", "HH_Type", "Religion", "Social_Group", "whether_Land_owned", "Land_total_possessed", "NSS.x", "NSC.x", "MLT.x", "Combined_multiplier.y.y", "Subsample_multiplier.y.y" )
...
food_selected <- food_merged%>%dplyr::select("HHID" , "ccs_val" , "val_159", "val_169",  "val_189" , "val_199" ,"fv_val",  "otherfd" ,"price_ccs" ,"price159", "price169" ,"price189" , "price199" , "price_fv" , "price_otherfd" ,"foodexp",
                                             ...
                                             "Religion"      ,     "Social_Group" ,            "whether_Land_owned"  ,     "Land_total_possessed"    , "NSS.x" ,                  
                                             "NSC.x" ,         "MLT.x"  ,     "Combined_multiplier.y.y" , "Subsample_multiplier.y.y")
